...
9. Must code a fuction to don't leave pleyer who have seted in past 14 days vacation mode to set another vacation mode</br></br>
10. Artefact storage master plan can bulild great granny and great warehouse on any village except capital. Effect account. Templates/Build/available.tpl (if($mainbuilding >= 10 && $village->capital == 0)</br></br>
11. Artefact storage masterplan effect village can build great granny and great warehouse even if artefact is inactive and even you dont have warehouse at level 20 and granny level 20</br></br>
12. Oassis loiality from 100 to 0 directly must be 100-60-20-0</br></br>
13. Graphic pack is enabled but must be fully coded</br></br>
14. In profile.tpl must be coded option for sitters (access for what)</br></br>
15. When you attack a village and destry it with catapult , after distroy all troops will be lose (no return home)</br></br>
16. Troops don`t consume crop from villange when you send as reinforcements on oassis. Must to consume from villang when troops are reinforcement on anexed oassis.</br></br>
17. When you try to steal an artefact (you have treasurey level 10) and attack with another player (with treasury level 20 and 2 artefacts) , you steal both artefact. Here is a bug , if you have level 10 treasurey you can steal both artefact even second artefact is large artefact and need treasurey level 20</br></br>
</div>
</div>
