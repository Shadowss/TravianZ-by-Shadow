...
8. Time zone from preference.tpl and also all options must to coded and also must coded in profile.tpl sitters options</br></br>
9. 403 , 404 , 500 Errors doesnt work.</br></br>
10. Palace must can be build in only one village. If you have palace in one village you cannot build another palace in other village only if you demolish in first village.</br></br>
11. Great warehouse and grate granny must be build only if you have granny and warehouse at level 20</br></br>
12. Regenerate troops on oasis</br></br>
13. Hero don't lose life points. Just die on bigger attack</br></br>
14. Vacation mode not remove automaticaly after vacation past, i mean you can log in after pass 2 days but player have set vac_mode to 1 and cannot be attacked</br></br>
15. Can send merchants to player who have vacation mode activated.</br></br>
16. Must code a fuction to don't leave pleyer who have seted in past 14 days vacation mode to set another vacation mode</br></br>
17. Artefact storage master plan can bulild great granny and great warehouse on any village except capital. Effect account.</br></br>
18. Artefact storage masterplan effect village can build great granny and great warehouse even if artefact is inactive and even you sont have warehouse at level 20 and granny level 20</br></br>
19. Oassis loiality from 100 to 0 directly must be 100-60-20-0</br></br>
20. Register page must be corrected (modify travian x with server name code)</br></br>
21. If you are banned and in vacation mode you can send resource from market (error in Templates/Build/17.tpl on line 28)
</div>
</div>
