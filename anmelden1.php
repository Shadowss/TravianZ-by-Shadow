...
<table cellpadding="1" cellspacing="1" id="sign_select">
	<tbody>
		...
		<tr>
			<td class="nat">
				<label><input class="radio" type="radio" name="vid" value="1" <?php echo $form->getRadio('vid',1); ?>>&nbsp;<?php echo ROMANS; ?></label><img src="img/reg/a.gif" class="tribeImage romans" alt="<?php echo ROMANS; ?>" title="<?php echo ROMANS; ?>" /></td>
			&nbsp;<td class="pos1"><label><input class="radio" type="radio" name="kid" value="0" checked>&nbsp;<?php echo RANDOM; ?></label></td>
			<td class="pos2">&nbsp;</td>
		</tr>
		<tr>
			<td class="nat"><label><input class="radio" type="radio" name="vid" value="2" <?php echo $form->getRadio('vid',2); ?>>&nbsp;<?php echo TEUTONS; ?></label><img src="img/reg/b.gif" class="tribeImage romans" alt="<?php echo TEUTONS; ?>" title="<?php echo TEUTONS; ?>" /></td>
		...
		<tr class="btm">
			<td class="nat"><label><input class="radio" type="radio" name="vid" value="3" <?php echo $form->getRadio('vid',3); ?>>&nbsp;<?php echo GAULS; ?></label><img src="img/reg/c.gif" class="tribeImage romans" alt="<?php echo GAULS; ?>" title="<?php echo GAULS; ?>" /></td>
