    ...
    <table cellpadding="1" cellspacing="1" id="download">
        ...
        <tbody>
				...
				<td class="nam">Travian T3.6 - T4 Building</td>
                                        <td class="size">4</td>
                    <td class="act"><a href="spieler.php?s=4&gp_type=custom&custom_url=gpack/travian3.6/">Activate</a></td>

                    <td class="down"><a href="gpack/download/travian_default.zip" target="_blank">Download</a></td>
			</tr>
			<tr>
				<td class="nam">Travian T4 </td>
                                        <td class="size">4</td>
                    <td class="act"><a href="spieler.php?s=4&gp_type=custom&custom_url=gpack/travian4/">Activate</a></td>

                    <td class="down"><a href="gpack/download/travian_default.zip" target="_blank">Download</a></td>
			</tr>
			<tr>
				<td class="nam">Travian Winter </td>
                                        <td class="size">4</td>
                    <td class="act"><a href="spieler.php?s=4&gp_type=custom&custom_url=gpack/winter_land/">Activate</a></td>
