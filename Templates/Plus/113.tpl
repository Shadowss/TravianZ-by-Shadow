	...
	<tbody>
		<tr>
			...
			<td class="desc">
            				...
            				<a href="#"
					onclick="window.open('http://billing.micropayment.de/call2pay/event/?account=24913&project=trvnx&theme=default&gfx=x-surfer&bgcolor=ffffff&title=travianix-1000+Gold&amount=1999','nsrpay','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">
	...
	<tbody>
		<tr>
			...
			<td class="desc">
            				...
            				<a href="#"
					onclick="window.open('http://billing.micropayment.de/ebank2pay/event/?account=24913&project=trvnx&theme=default&gfx=x-surfer&bgcolor=ffffff&title=travianix+1000+Gold&amount=1999&currency=EUR&paytext=travianix+1000+Gold','nsrpay','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">
...
<!--<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
            ...
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=T3BJ9XR8PQ3DL" target="_blank">
