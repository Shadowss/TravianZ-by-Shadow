	...
	<tbody>
		<tr>
			...
			<td class="desc">
            				...
            				<a href="#"
					onclick="window.open('http://billing.micropayment.de/call2pay/event/?account=24913&project=trvnx&theme=default&gfx=x-surfer&bgcolor=ffffff&title=travianix-120+Gold&amount=499','nsrpay','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">
	...
	<tbody>
		<tr>
			...
			<td class="desc">
            				...
            				<a href="#"
					onclick="window.open('http://billing.micropayment.de/handypay/event/?account=24913&project=trvnx&theme=default&gfx=x-surfer&bgcolor=ffffff&title=travianix-120+Gold&amount=499&paytext=TravianiX+120+Gold&smstext=travianix120gold','nsrpay','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">
	...
	<tbody>
		<tr>
			...
			<td class="desc">
            				...
            				<a href="#"
					onclick="window.open('http://billing.micropayment.de/ebank2pay/event/?account=24913&project=trvnx&theme=default&gfx=x-surfer&bgcolor=ffffff&title=travianix+120+Gold&amount=499&currency=EUR&paytext=travianix+120+Gold','nsrpay','scrollbars=yes,status=yes,resizable=yes,toolbar=yes,width=800,height=600');return false;">
...
<!--<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
			...
			<div>Wait: 24 Stunden<br />nach Geldeingang</div>
			</td>
			<td class="desc">Bezahlung per Paypal einleiten<br />
            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8Z52MGA7NZ62J" target="_blank">
