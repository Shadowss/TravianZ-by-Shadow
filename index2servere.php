							...
							<tbody>
								<tr>
									...
									<td><?php
										   ...
										   $users1 = mysql_num_rows(mysql_query("SELECT * FROM " . TB_PREFIX . "users WHERE tribe!=0 AND tribe!=4 AND tribe!=5"));
                                           $users2 = mysql_num_rows(mysql_query("SELECT * FROM s2_users WHERE tribe!=0 AND tribe!=4 AND tribe!=5")); 
										   echo $users;
								...
								<tr>
									...
									<td><?php
										   ...
										   $active1 = mysql_num_rows(mysql_query("SELECT * FROM " . TB_PREFIX . "users WHERE " . time() . "-timestamp < (3600*24) AND tribe!=0 AND tribe!=4 AND tribe!=5"));
                                           $active2 = mysql_num_rows(mysql_query("SELECT * FROM s2_users WHERE " . time() . "-timestamp < (3600*24) AND tribe!=0 AND tribe!=4 AND tribe!=5")); 
										   echo $active;
								...
								<tr>
									...
									<td><?php
										   ...
										   $online1 = mysql_num_rows(mysql_query("SELECT * FROM " . TB_PREFIX . "users WHERE " . time() . "-timestamp < (60*5) AND tribe!=0 AND tribe!=4 AND tribe!=5"));
                                           $online2 = mysql_num_rows(mysql_query("SELECT * FROM s2_users WHERE " . time() . "-timestamp < (60*5) AND tribe!=0 AND tribe!=4 AND tribe!=5")); 
										   echo $online;
		...
		<div id="login_list" class="overlay_content">
			...
			<ul class="world_list">
				<li class="w_big c3" style="background-image:url('img/en/welten/en1_big_g.jpg');">
                    <a href="login.php"><img class="w_button" src="img/un/x.gif" alt="World" title="<?php echo $users1; echo "&nbsp;"; echo PLAYERS; echo "&nbsp;|&nbsp;"; echo $active1; echo "&nbsp;"; echo ACTIVE; echo "&nbsp;|&nbsp;"; echo $online1; echo "&nbsp;"; echo ONLINE; ?>" /></a>
                    <div class="label_players c0"><?php echo PLAYERS; ?>:</div>
                    <div class="label_online c0"><?php echo ONLINE; ?>:</div>
                    <div class="players c1"><?php echo $users1; ?></div>
                    <div class="online c1"><?php echo $online1; ?></div>
                </li>
                <li class="w_big c3" style="background-image:url('img/en/welten/en2_big_g.jpg');">
                    <a href="TravianZ/login.php"><img class="w_button" src="img/un/x.gif" alt="World" title="<?php echo $users2; echo "&nbsp;"; echo PLAYERS; echo "&nbsp;|&nbsp;"; echo $active2; echo "&nbsp;"; echo ACTIVE; echo "&nbsp;|&nbsp;"; echo $online2; echo "&nbsp;"; echo ONLINE; ?>" /></a>
                    <div class="label_players c0"><?php echo PLAYERS; ?>:</div>
                    <div class="label_online c0"><?php echo ONLINE; ?>:</div>
                    <div class="players c1"><?php echo $users2; ?></div>
                    <div class="online c1"><?php echo $online2; ?></div>
                </li>
			</ul>
		...
		<div id="signup_list" class="overlay_content">
			...
			<ul class="world_list">
				<li class="w_big c4" style="background-image:url('img/en/welten/en1_big.jpg');">
                    <a href="anmelden.php"><img class="w_button" src="img/un/x.gif" alt="World" title="<?php echo $users1; echo "&nbsp;"; echo PLAYERS; echo "&nbsp;|&nbsp;"; echo $active1; echo "&nbsp;"; echo ACTIVE; echo "&nbsp;|&nbsp;"; echo $online1; echo "&nbsp;"; echo ONLINE; ?>" /></a>
                    <div class="label_players c0"><?php echo PLAYERS; ?>:</div>
                    <div class="label_online c0"><?php echo ONLINE; ?>:</div>
                    <div class="players c1"><?php echo $users1; ?></div>
                    <div class="online c1"><?php echo $online1; ?></div>
                </li>
                <li class="w_big c4" style="background-image:url('img/en/welten/en2_big.jpg');">
                    <a href="anmelden.php"><img class="w_button" src="img/un/x.gif" alt="World" title="<?php echo $users2; echo "&nbsp;"; echo PLAYERS; echo "&nbsp;|&nbsp;"; echo $active2; echo "&nbsp;"; echo ACTIVE; echo "&nbsp;|&nbsp;"; echo $online2; echo "&nbsp;"; echo ONLINE; ?>" /></a>
                    <div class="label_players c0"><?php echo PLAYERS; ?>:</div>
                    <div class="label_online c0"><?php echo ONLINE; ?>:</div>
                    <div class="players c1"><?php echo $users2; ?></div>
                    <div class="online c1"><?php echo $online2; ?></div>
