...
<head>
	<title>Powered by Shadow v.7.0 - <?php echo SERVER_NAME; ?></title>
		...
		<div id="footer">
			<div class="container">
				...
				<ul class="menu">
					...
					<li><a href="screenshots.php"><?php echo SCREENSHOTS; ?></a>|</li>
					...
					<li class="copyright">&copy; 2011-2013 - Travian - All rights reserved</li>
				</ul>
			</div>
		</div>
	</div>
